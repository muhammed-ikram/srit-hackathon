...
import { ShieldCheck, MessageSquare, Clock, CheckCircle, XCircle, Search, Filter, User, Info, Send } from "lucide-react";
        ...
        <div className="min-h-screen bg-black text-white p-8 md:p-12">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="space-y-6">
                        {loading ? (
                            ...
                            <div className="text-center py-24 bg-white/[0.02] border border-dashed border-white/10 rounded-[3rem]">
                                <p className="text-slate-400 text-xl font-medium">No complaints found matching criteria.</p>
                            </div>
                        ) : (
                            filteredComplaints.map(complaint => (
                                <motion.div 
                                    ...
                                    className={`p-8 bg-white/[0.03] border rounded-[2.5rem] cursor-pointer transition-all hover:bg-white/[0.06] ${selectedComplaint?._id === complaint._id ? 'border-emerald-500/50' : 'border-white/10'}`}
                                >
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-8 bg-white/[0.03] border border-white/10 rounded-[2.5rem] p-8 min-h-[500px] flex flex-col">
                            ...
                            <div className="flex flex-col flex-1">
                                ...
                                <div className="space-y-4 flex-1">
                                    ...
                                    <textarea 
                                        ...
                                        placeholder="Enter the actions taken or explanation for resolution..."
                                    ...
                                    <div className="grid grid-cols-1 gap-4 pt-6">
                                        <button 
                                            ...
                                            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                                        >
